  ...
  return (
    <div className="bg-[#15130f] text-foreground">
      <section className="relative min-h-[720px] overflow-hidden border-b-8 border-amber-400">
        <img src={machineryHero} alt="Yellow tracked excavator and agricultural tractor at an Ethiopian earthworks site" width={1600} height={1000} className="absolute inset-0 h-full w-full object-cover" />
